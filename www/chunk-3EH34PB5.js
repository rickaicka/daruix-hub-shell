import { i as c } from "@nf-internal/chunk-NTOTMM2V";
import { a as l, e as v, h as y, k as w } from "@nf-internal/chunk-DPCBKAOC";
import { h as s } from "@nf-internal/chunk-C4FLJMU7";
var V = "ionViewWillEnter", k = "ionViewDidEnter", T = "ionViewWillLeave", _ = "ionViewDidLeave", N = "ionViewWillUnload", r = n => { n.tabIndex = -1, n.focus(); }, d = n => n.offsetParent !== null, p = () => ({ saveViewFocus: i => { if (l.get("focusManagerPriority", !1)) {
        let a = document.activeElement;
        a !== null && i?.contains(a) && a.setAttribute(b, "true");
    } }, setViewFocus: i => { let t = l.get("focusManagerPriority", !1); if (Array.isArray(t) && !i.contains(document.activeElement)) {
...
} }), C = (n, e) => { e ? (n.setAttribute("aria-hidden", "true"), n.classList.add("ion-page-hidden")) : (n.hidden = !1, n.removeAttribute("aria-hidden"), n.classList.remove("ion-page-hidden")); }, O = (n, e, i) => { n !== void 0 && (n.style.zIndex = i === "back" ? "99" : "101"), e !== void 0 && (e.style.zIndex = "100"); }, P = (n, e) => { if (!n)
    return; let i = "header-transitioning"; e ? n.classList.add(i) : n.classList.remove(i); }, Z = n => { if (n.classList.contains("ion-page"))
    return n; let e = n.querySelector(":scope > .ion-page, :scope > ion-nav, :scope > ion-tabs"); return e || n; }, Y = n => { let e = n.enteringEl, i = n.leavingEl, t = n.direction; if (n.mode !== "ios")
    return null; let o = t === "back" ? i : e; return o ? o.querySelector("ion-header") : null; };
export { T as a, _ as b, N as c, $ as d, u as e, G as f, E as g, C as h, Z as i };
